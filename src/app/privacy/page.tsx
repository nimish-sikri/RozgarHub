...
const PrivacyPolicy = () => {
  return (
    <div className="container">
      ...
      <p>
        <strong>3. How IEIL may use your Personal Information</strong>
      </p>
      <p>
      ...
      <p>
        <strong>4. Cookies and Other Tracking Technologies</strong>
      </p>
      <p>
      ...
      <p>
        <strong>5. The Basis/Grounds which we rely on for collection and processing of your Personal Information:</strong>
      </p>
      <p>
      ...
      <p>
        <strong>6. Information Sharing and Disclosure</strong>
      </p>
      <p>
      ...
      <p>
        Naukri’s use and transfer to any other app of information received from Google APIs will adhere to Google API Services User Data Policy, including the Limited Use requirements.
      </p>
      <p>
      ...
      <p>
        <strong>9. Retention of Personal Information</strong>
      </p>
      <p>
      ...
      <p>
        <strong>10. Controlling your personal information</strong>
      </p>
      <p>
      ...
      <p>
        At any time, if you wish to delete your account on Rozgar Hub, you may do so by using the settings available in your account.
      </p>
      <p>
        <strong>11. Confidentiality and Security</strong>
      </p>
      <p>
      ...
      <ul>
        ...
        <li>
          Excessive, inappropriate, offensive or defamatory content. IEIL is not responsible for any information posted on those sites other than the information posted by its employees on its behalf. IEIL is only responsible for its own use of the Personal Information received through such sites.
        </li>
      </ul>
